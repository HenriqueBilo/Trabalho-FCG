...
int main(int argc, char* argv[])
{
    ...
    float time_count_start = glfwGetTime();
    ...
    {
        player.movement_speed = g_MovementSpeed * ((float)glfwGetTime() - time_count_start);
        time_count_start = glfwGetTime();
        ...
        {
            model = Matrix_Translate( green_key.sphere_collider.center.x,
        ...
        {
            model = Matrix_Translate(  blue_key.sphere_collider.center.x,
        ...
        {
            model = Matrix_Translate(  red_key.sphere_collider.center.x,
